...
class TemplateGenerator:
    ...
    def create_docx_from_markdown(markdown_content: str, template_style: str, 
        ...
        try:
            ...
            docx_output_path = os.path.join(os.getcwd(), "resume.docx")
            if os.path.exists(docx_output_path):
                import shutil
                shutil.move(docx_output_path, output_path)
                return True
    ...
    @staticmethod
    def _generate_custom_template_js(sections: Dict, style: str, color: str) -> str:
